...
from game.rhythm import RhythmManager, calculate_lead_in
...
from game.menu import PauseScreen
from game.screens import SettingsPanel
from game.menu_utils import _FONT
...
class Game(EffectsMixin, MechanicsMixin):
    def __init__(self, level, screen=None, clock=None, music=None) -> None:
        ...
        from game.ui_components import PNGSequenceSprite as _PSS
    ...
    def update(self, dt: float) -> None:
        ...
        if _trigger_outro:
            ...
            if outro_elapsed >= 1.0 and not self._outro_finish_started:
                ...
                pygame.mixer.music.stop()
                from game import audio_manager as _am
